...
class UrlAliasHandlerTest extends TestCase
{
    ...
    public function providerForTestLookupLocationUrlAlias()
    {
        return array(
            array(
                "jedan",
                array( array( "always-available" => "jedan" ) ),
                array( array( "always-available" ) ),
                array( "cro-HR" ),
                true,
                314,
            ...
            array(
                ...
                array( array( "always-available" ), array( "cro-HR" ) ),
                array( "cro-HR" ),
                false,
                315,
            ...
            array(
                ...
                array( array( "always-available" ), array( "eng-GB" ) ),
                array( "eng-GB" ),
                false,
                315,
            ...
            array(
                ...
                array( array( "always-available" ), array( "cro-HR" ), array( "cro-HR" ) ),
                array( "cro-HR" ),
                false,
                316,
            ...
            array(
                ...
                array( array( "always-available" ), array( "eng-GB" ), array( "eng-GB" ) ),
                array( "eng-GB" ),
                false,
                316,
            ...
            array(
                ...
                array( array( "always-available" ), array( "cro-HR" ), array( "eng-GB" ) ),
                array( "eng-GB" ),
                false,
                316,
                "3-35d6d33467aae9a2e3dccb4b6b027878"
            ...
            array(
                ...
                array( array( "always-available" ), array( "eng-GB" ), array( "cro-HR" ) ),
                array( "cro-HR" ),
                false,
                316,
                "3-d2cfe69af2d64330670e08efb2c86df7"
            ...
            array(
                ...
                array( array( "always-available" ), array( "cro-HR" ), array( "ger-DE" ) ),
                array( "ger-DE" ),
                false,
                316,
            ...
            array(
                ...
                array( array( "always-available" ), array( "eng-GB" ), array( "ger-DE" ) ),
                array( "ger-DE" ),
                false,
                316,
                "3-1d8d2fd0a99802b89eb356a86e029d25"
    ...
    public function providerForTestLookupLocationMultipleLanguages()
    {
        return array(
            array(
                ...
                array( array( "always-available" ), array( "cro-HR", "eng-GB" ) ),
                array( "cro-HR", "eng-GB" ),
                false,
                315,
                "2-c67ed9a09ab136fae610b6a087d82e21"
            ...
            array(
                ...
                array( array( "always-available" ), array( "cro-HR", "eng-GB" ), array( "cro-HR" ) ),
                array( "cro-HR" ),
                false,
                316,
                "3-d2cfe69af2d64330670e08efb2c86df7"
            ...
            array(
                ...
                array( array( "always-available" ), array( "cro-HR", "eng-GB" ), array( "eng-GB" ) ),
                array( "eng-GB" ),
                false,
                316,
                "3-35d6d33467aae9a2e3dccb4b6b027878"
        ...
        self::assertEquals(
            new UrlAlias(
                array(
                    ...
                    "pathLanguageCodes" => array( array( "always-available" ), array( "cro-HR" ), array( "cro-HR" ) ),
    ...
    public function providerForTestLookupCustomLocationUrlAlias()
    {
        return array(
            array(
                ...
                array(
                    array(
                        "always-available" => "autogenerated-hello",
                    ),
                    array(
                        "always-available" => "everybody",
                    ),
                ),
                array( array( "always-available" ), array( "always-available" ) ),
                array( "eng-GB" ),
                false,
                true,
                315,
            ...
            array(
                ...
                array( array( "eng-GB" ), array( "always-available" ), array( "eng-GB" ) ),
                array( "eng-GB" ),
                true,
                false,
                316,
            ...
            array(
                ...
                array( array( "eng-GB" ), array( "eng-GB" ) ),
                array( "eng-GB" ),
                true,
                false,
                315,
    ...
    public function providerForTestLookupResourceUrlAlias()
    {
        return array(
            array(
                "is-alive",
                array( array( "always-available" => "is-alive" ) ),
                array( array( "always-available" ) ),
                array( "eng-GB" ),
                true,
                true,
            ...
            array(
                ...
                array( array( "always-available" ), array( "always-available" ), array( "eng-GB" ) ),
                array( "eng-GB" ),
                false,
                false,
                "content/search",
        ...
        self::assertEquals(
            new UrlAlias(
                array(
                    ...
                    "destination" => 314,
                    "languageCodes" => array( "cro-HR" ),
                    "pathData" => array( array( "always-available" => "dva" ) ),
                    "pathLanguageCodes" => array( array( "always-available" ) ),
        ...
        self::assertEquals(
            new UrlAlias(
                array(
                    ...
                    "destination" => 314,
                    "languageCodes" => array( "cro-HR" ),
                    "pathData" => array( array( "cro-HR" => "jedan" ) ),
    ...
    public function testPublishUrlAliasForLocationDowngradesOldEntryRemovesLanguage()
    {
        ...
        $handler->publishUrlAliasForLocation( 314, "jedan", "cro-HR", false );
        $handler->publishUrlAliasForLocation( 314, "jedan", "eng-GB", false );
        $handler->publishUrlAliasForLocation( 314, "dva", "eng-GB", false );
    ...
    public function testPublishUrlAliasForLocationReusesCustomAlias()
    {
        ...
        $handler->publishUrlAliasForLocation( 314, "custom-hello", "eng-GB", false );
    ...
    public function testPublishUrlAliasForLocationReusingNopElement()
    {
        ...
        $handler->publishUrlAliasForLocation( 315, "nop-element", "eng-GB", false );
        ...
        self::assertEquals(
            new UrlAlias(
                array(
                    ...
                    "alwaysAvailable" => false,
                    "pathData" => array( array( "eng-GB" => "nop-element" ) ),
                    "pathLanguageCodes" => array( array( "eng-GB" ) ),
                    "isHistory" => false,
                    "isCustom" => false,
                    "forward" => false
                )
     ...
     *
     * @covers \eZ\Publish\Core\Persistence\Legacy\Content\UrlAlias\Handler::publishUrlAliasForLocation
     * @_depends testPublishUrlAliasForLocationReusingNopElement
     * @_depends testLookupLocationUrlAliasThrowsNotFoundException
     * @_depends testLookupLocationUrlAliasFound
     * @_depends testLookupLocationCaseCorrection
     */
    public function testPublishUrlAliasForLocationReusingNopElementChangesCustomPath()
    {
        ...
        $virtualUrlAlias = $handler->lookup( "nop-element/search" );
        $handler->publishUrlAliasForLocation( 315, "nop-element", "eng-GB", false );
        $handler->publishUrlAliasForLocation( 315, "nop-element-renamed", "eng-GB", false );
        ...
        foreach ( $virtualUrlAliasChanged as $propertyName => $propertyValue )
        {
            ...
            elseif ( $propertyName === "pathData" )
            {
                self::assertEquals(
                    array(
                        array( "eng-GB" => "nop-element-renamed" ),
                        array( "eng-GB" => "search" ),
                    ),
    ...
    public function testPublishUrlAliasForLocationReusingNopElementChangesCustomPathAndCreatesHistory()
    {
        ...
        foreach ( $virtualUrlAliasHistory as $propertyName => $propertyValue )
        {
            ...
            else
            {
                self::assertEquals(
                    $virtualUrlAliasChanged->$propertyName,
                    $virtualUrlAliasHistory->$propertyName
                );
            }
        }
    }
    ...
    public function testCreatedCustomUrlAliasIsLoadable()
    {
        ...
        self::assertEquals( 2, $this->countRows() );
        self::assertEquals(
            $handler->lookup( "custom-location-alias" ),
            $customUrlAlias
        );
    }
